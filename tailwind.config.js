...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'pixel-grid': "url(\"data:image/svg+xml,%3Csvg width='20' height='20' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%2300ffff' fill-opacity='0.1'%3E%3Crect width='1' height='1'/%3E%3C/g%3E%3C/svg%3E\")",
